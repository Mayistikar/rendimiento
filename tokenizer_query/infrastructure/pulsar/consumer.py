import pulsar
import json
from tokenizer_query.application.service_tokenizer_query import ITokenizerQueryService
...
class Consumer:
    def __init__(self, config, tokenizer_cmd_service: ITokenizerQueryService):
    ...
    def run(self):
        try:
            while True:
                ...
                print("Received message from Tokenizer QUERY: '%s'" % medical_record_dto)
